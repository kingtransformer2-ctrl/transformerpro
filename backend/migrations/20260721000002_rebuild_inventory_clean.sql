...
-- Drop everything inventory-related to start fresh
...
CREATE TABLE public.stock_ledger (
  ...
  transaction_type TEXT NOT NULL CHECK (transaction_type IN ('PURCHASE','TRANSFER_OUT','TRANSFER_IN','SALE_DEDUCTION','WASTAGE','ADJUSTMENT','RETURN','OPENING','STOCK_IN','STOCK_OUT')),
...
BEGIN
  ...
  END IF;
  -- Validate balance only for outgoing types

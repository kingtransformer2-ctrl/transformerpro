-- Keep table-session summary status aligned with live split-bill calculations.
-- This avoids stale stored status/payment_status values when the summary is used
-- as the source of truth for billing and cashier views.
